...
type OAuthHandler struct {
	oauthFactory *services.OAuthFactory
	tokenSvc     services.AuthTokenService
}

func NewOAuthHandler(tokenSvc services.AuthTokenService) *OAuthHandler {
	factory := services.NewOAuthFactory()
	...
	if googleClientID != "" && googleClientSecret != "" {
		factory.Register("google", services.NewGoogleProvider(
			googleClientID,
			googleClientSecret,
	...
	if githubClientID != "" && githubClientSecret != "" {
		factory.Register("github", services.NewGitHubProvider(
			githubClientID,
			githubClientSecret,
	...
	if msClientID != "" && msClientSecret != "" {
		factory.Register("microsoft", services.NewMicrosoftProvider(
			msClientID,
			msClientSecret,
	...
	if appleClientID != "" {
		factory.Register("apple", services.NewAppleProvider(
			appleClientID,
			appleTeamID,
			appleKeyID,
			appleSecret,
