...
// ScheduledLesson represents a scheduled lesson/booking with a teacher
...
func (ScheduledLesson) TableName() string {
	return "Lesson"
}

func (l *ScheduledLesson) BeforeCreate(tx *gorm.DB) (err error) {
	if l.ID == "" {
