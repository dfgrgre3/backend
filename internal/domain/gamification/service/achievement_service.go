...
type achievementService struct {
	achievementRepo gamificationrepo.AchievementRepository
}

func NewAchievementService(achievementRepo gamificationrepo.AchievementRepository) AchievementService {
