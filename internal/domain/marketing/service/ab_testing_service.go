...
import (
	...
	marketingrepo "thanawy-backend/internal/infrastructure/persistence/repositories"
	"time"
)
...
type abTestingService struct {
	repo             marketingrepo.ABExperimentRepository
...
func NewABTestingService() ABTestingService {
	...
	return newABTestingService(marketingrepo.NewABExperimentRepository(), []byte(secret))
}

func newABTestingService(repo marketingrepo.ABExperimentRepository, assignmentSecret []byte) *abTestingService {
