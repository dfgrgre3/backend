...
func (f *fakeABExperimentRepository) Create(context.Context, *models.ABExperiment) error {
	return nil
}
...
func (f *fakeABExperimentRepository) Update(context.Context, *models.ABExperiment) error {
	return nil
}
