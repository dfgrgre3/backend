...
//
// The Redis client is resolved lazily via GetRedis() on every operation so
...
var (
	...
	globalEnhancedCacheOnce sync.Once
)

// GetEnhancedCache returns the process-wide enhanced cache instance.
